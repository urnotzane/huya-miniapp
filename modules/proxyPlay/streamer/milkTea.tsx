...
export const StreamerMilkTeaFc: FC<{}> = () => {
    ...
    <>
      <View style={{
        ...
        <View style={{
          ...
          <Text style={{ marginTop: 5, color: '#999' }}>送你一杯奶茶并雇你玩游戏</Text>
        </View>
        <Button type="primary" size="sm" style={{
          paddingTop: 5,
          paddingBottom: 5,
        }} onPress={handleMilkTea}>查看账号</Button>
      </View>
      {/* @ts-ignore */}
      <Dialog
        ref={(c) => {
        ...
        body={<View style={{ padding: 20 }}>
          <Text>账号：10***2126</Text>
          <Text className="text">角色：鼠鼠熬夜</Text>
          <Text className="text">大区：德玛西亚</Text>
        </View>}
        cancelable={true}
        cancelCallback={() => {
          console.log('cancel')
